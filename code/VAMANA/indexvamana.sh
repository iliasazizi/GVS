...
#options="--queries ${CURR_QUERIES} --queries-size ${NQ} --index-path $INDEX/HNSW_${SIZE}_${LS}_${M}_${EFC}_${DATASET}/ --timeseries-size $LEN  --k ${K} --ef ${EF}  --mode 1 --flatt 0
options="--dataset $1 --dataset_size $2 --timeseries_size $3 --index $4 --K $5 --L $6 --C $7 --alpha $8 --nthrds 110 --mode $9  &> ${10}"
